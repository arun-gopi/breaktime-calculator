...
class DatabaseManager:
    ...
    def _init_default_configs(self):
        ...
        defaults = [
            ...
            ('break_threshold_2', '6', 'float', 'Second break threshold in hours'),
            ('break_threshold_3', '10', 'float', 'Third break threshold in hours'),
            ('break_threshold_4', '14', 'float', 'Fourth break threshold in hours'),
