...
from app.services.break_calculator import get_break_configuration
...
async def home(request: Request):
    ...
    return templates.TemplateResponse("index.html", {"request": request, "user": user, "break_config": break_config})
