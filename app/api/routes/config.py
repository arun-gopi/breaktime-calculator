...
async def reset_config(request: Request, user: dict = Depends(get_current_user)):
    ...
    defaults = [
        ...
        ('break_threshold_1', '3.5', 'float', 'First break threshold in hours'),
        ('break_threshold_2', '6.0', 'float', 'Second break threshold in hours'),
        ('break_threshold_3', '10.0', 'float', 'Third break threshold in hours'),
        ('break_threshold_4', '14.0', 'float', 'Fourth break threshold in hours'),
        ...
        ('break_duration_4', '40', 'int', 'Total duration for four breaks in minutes'),
